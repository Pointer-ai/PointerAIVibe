...
1. **创建用户档案** - 设置你的学习身份
2. **配置API密钥** - 在Profile设置中配置OpenAI/Claude/通义千问API
3. **完成能力评估** - 上传简历或完成技能问卷
4. **体验真实AI对话** - 进入"AI智能对话"开始智能交互
5. **测试Function Calling** - 在"AI系统演示"中体验所有AI工具
...
### 🧪 Function Calling测试指南 ✅

#### 快速测试方法
1. **🔧 配置API密钥**：Profile设置 → API配置 → 选择模型并输入API Key
2. **🧪 自动测试**：AI系统演示 → "🧪 真实LLM Function Calling测试" → 点击"🧪 自动测试"
3. **💬 对话测试**：AI智能对话 → 输入"我想看看我的学习目标"
...
# 场景1: 查询学习数据
"我想看看我的学习目标"
# 预期: 自动调用 get_learning_goals 工具

# 场景2: 创建学习内容  
"我想学习Python数据科学"
# 预期: 自动调用 create_learning_goal 和 create_learning_path 工具
...
# 场景4: 处理学习困难
"我觉得学习太难了"
# 预期: 调用 handle_learning_difficulty 工具

# 场景5: 进度跟踪
"我现在的学习进度如何？"
# 预期: 调用 track_learning_progress 工具
```
